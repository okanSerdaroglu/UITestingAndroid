...
import com.example.espressouitesting.ui.ImageViewHasDrawableMatcher.hasDrawable
...
class CameraActivityTest {
    ...
    fun test_cameraIntent_isBitmapSetToImageView() {
        ...
        intending(expectedIntent).respondWith(activityResult) // when expected intent called return activityResult
